...
export default function DemoHookUseEffect(props) {
    ...
    // Cách viết thay thế cho componentDidmount, để mảng rỗng: chỉ chạy 1 lần duy nhất khi render
    useEffect(() => {
        console.log('didmount');
    ...
    return (
        <div className="m-5">
            <button className="btn btn-success" onClick={() => { setLike(like + 1) }}> Like </button>
