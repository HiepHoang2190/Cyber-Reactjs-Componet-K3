...
export default function Ex6UseChain() {
    ...
    const propsAnim = useSpring({
        opacity: 1, width: '100%', height: '100%', from: { opacity: 0, width: '0%', height: '0%' }, config: { duration: 500 },
        // ref: springRef
    })
    ...
    return <div className="container">
        <animated.div style={propsAnim} >
            {transitions((propsAnim2, item) => (
                <animated.div style={propsAnim2} className="bg-dark text-white p-3 mt-2 mb-2"  >
