...
export default function Ex5UseTransition(props) {
    ...
    let renderItem = () => {
        ...
        return propsUseTransition((propsAnim, item) => {
            return <animated.div style={propsAnim} className="bg-dark text-white p-3 mt-2">
    ...
    const deleteItem = (id) => {
        // set lại arrItem mới = cách lấy những phần tử  != id đó=> giống như tìm index xóa và cấp lại
